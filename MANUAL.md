...
### Web App (Playground)
- **Netlify site name**: `minions-bundles-knowledge-web`
- **GitHub repo**: `mxn2020/minions-bundles-knowledge`
...
### Documentation
- **Netlify site name**: `minions-bundles-knowledge-docs`
- **GitHub repo**: `mxn2020/minions-bundles-knowledge`
...
### Blog
- **Netlify site name**: `minions-bundles-knowledge-blog`
- **GitHub repo**: `mxn2020/minions-bundles-knowledge`
...
|--------|------|------|-------|
| Docs | CNAME | `knowledge.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `knowledge.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `knowledge.minions.wtf` | _(Netlify subdomain)_ |
